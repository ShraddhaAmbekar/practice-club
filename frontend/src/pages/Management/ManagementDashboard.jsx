...
function ManagementDashboard({ user, onLogout }) {
  ...
  const handleViewPlayer = async (playerId) => {
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "Player माहिती fetch करता आली नाही."
        );
      }
  ...
  const handleDeletePlayer = async (playerId) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "Player delete करताना error आला."
        );
      }
          ...
          <header className="bg-[#111111] border-b border-[#8A5A0A]/30">
            <div className="max-w-7xl mx-auto px-5 sm:px-8 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-xl bg-[#D4A017] flex items-center justify-center shadow-lg">
              ...
              <button
                onClick={onLogout}
                className="px-4 py-2 rounded-lg border border-[#111111]/20 bg-[#111111] text-xs font-bold text-white hover:bg-black transition"
              >
                Logout
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#E8D49A] shadow-[0_15px_50px_rgba(138,90,10,0.08)] overflow-hidden">
              ...
              <div className="p-6 sm:p-8 border-b border-[#F0E5C3]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-5">
                  ...
                  <Detail
                    label="जन्मतारीख"
                    value={formatDate(selectedPlayer.birthDate)}
                  />
              ...
              <div className="p-6 sm:p-8 border-b border-[#F0E5C3]">
                ...
                {selectedPlayer.memorableCompetitions?.length > 0 ? (
              ...
              <div className="p-6 sm:p-8">
                ...
                {selectedPlayer.relativesInPracticeClub?.length > 0 && (
        ...
        <header className="bg-gradient-to-r from-[#111111]  via-[#111111] to-[#D4A017] border-b border-[#111111]/30 sticky top-0 z-30">
          <div className="max-w-7xl mx-auto px-5 sm:px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={onLogout}
                className="px-4 py-2 rounded-lg bg-[#111111] text-white text-xs font-bold hover:bg-black transition"
              >
                Logout
              </button>
            </div>
                    ...
                    <tbody className="divide-y divide-[#F0E5C3]">
                      {players.map((player, index) => (
                        ...
                        >
                          ...
                          <td className="px-5 py-4">
                            <span className="text-xs text-[#111111] text-bold">
