...
const createPlayer = async (req, res) => {
  try {
    ...
    const player = await Player.create({
      ...
      familyMembersComing:
        familyMembersComing !== undefined &&
        familyMembersComing !== ""
          ? Number(familyMembersComing)
          : 0,

      familyVegMembers:
        familyVegMembers !== undefined &&
        familyVegMembers !== ""
          ? Number(familyVegMembers)
          : 0,

      familyNonVegMembers:
        familyNonVegMembers !== undefined &&
        familyNonVegMembers !== ""
          ? Number(familyNonVegMembers)
          : 0,
